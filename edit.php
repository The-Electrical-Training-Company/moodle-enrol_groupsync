...
$PAGE->set_url('/enrol/groupsync/edit.php', ['courseid' => $course->id]);
...
$mform = new enrol_groupsync_edit_form(null, [$instance, $enrol, $course]);

if ($mform->is_cancelled()) {
    redirect($returnurl);

} else if ($data = $mform->get_data()) {
    $enrol->add_instance($course, ['name' => $data->name, 'status' => ENROL_INSTANCE_ENABLED,
